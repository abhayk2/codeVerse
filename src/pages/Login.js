...
export const Login = () => {
    ...
    async function handleLoginGuest() {
        email.current.value = "ak@gmail.com";
        password.current.value = "react555";
        try {
            const authDetail = {
                email: email.current.value,
                password: password.current.value
